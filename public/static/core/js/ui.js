...
$(function () {
    ...
    function checkDataSet(dom, key) {
        var result;
        if (dom.dataset && dom.dataset[key]) {
            result = dom.dataset[key];
        } else if (dom.getAttribute) {
            result = dom.getAttribute('data-' + key);
        }
        return result;
    }
    ...
    function initNode(obj) {
        ...
        for (i = 0; i < obj.childNodes.length; i++) {
            nd = checkDataSet(obj.childNodes[i], 'node');
            if (nd) {
    ...
    ui.maskWith = function (element) {
        ...
        mask.hide = function (t) {
            mask.top.fadeOut(t);
            mask.right.fadeOut(t);
            mask.bottom.fadeOut(t);
            mask.left.fadeOut(t);
        };
        mask.show = function (t) {
            mask.top.fadeIn(t);
            mask.right.fadeIn(t);
            mask.bottom.fadeIn(t);
            mask.left.fadeIn(t);
        }
    ...
    $body.on('mouseenter', '.ft', function () {
        ...
        if (!this.flexTips) {
            ...
            var flex = checkDataSet(this, 'flex');
            if (flex) {
                this.flexTips.dwText.innerHTML = flex;
            }
